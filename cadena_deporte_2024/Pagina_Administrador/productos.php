...
<div><h1>  Productos</h1></div><br>
    <table id="myTable" class="display">
        <!-- ... (contenido de la tabla) ... -->
        <a href="agregarPro.php" class="btn btn-success">Agregar</a>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
            <a href="editarPro.php?id_producto=<?php echo $filas['id_producto']; ?>" class="btn btn-primary">Editar</a>
            <hr>
            <a href="eliminarPro.php?id_producto=<?php echo $filas['id_producto']; ?>" class="btn btn-danger">Eliminar</a>
