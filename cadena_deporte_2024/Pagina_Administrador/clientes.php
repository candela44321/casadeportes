...
<div><h1>  Clientes</h1></div><br>
    <table id="myTable" class="display">
        <!-- ... (contenido de la tabla) ... -->
        <a href="agregarCli.php" class="btn btn-success">Agregar</a>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
            <a href="editarCli.php?id_cliente=<?php echo $filas['id_cliente']; ?>" class="btn btn-primary">Editar</a>
            <hr>
            <a href="eliminarCli.php?id_cliente=<?php echo $filas['id_cliente']; ?>" class="btn btn-danger">Eliminar</a>
