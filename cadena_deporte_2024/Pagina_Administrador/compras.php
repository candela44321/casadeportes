...
<div><h1>  Compras</h1></div><br>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
            <a href="aceptar_pedido.php?id_compra=<?php echo $filas['id_compra']; ?>" class="btn btn-success">Aceptar Pedido</a><hr>
            <hr>
            <a href="cancelar_pedido.php?id_compra=<?php echo $filas['id_compra']; ?>" class="btn btn-danger">Cancelar Pedido</a>
